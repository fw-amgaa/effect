...
import { Q as getBooleanEnvVar, R as ENV, k as isTest, y as logger, e as env, T as getEnvVar } from "./better-auth__core.mjs";
import { b as betterFetch } from "./better-fetch__fetch.mjs";
import { a as createHash, f as base64, c as createRandomStringGenerator } from "./better-auth__utils.mjs";
...
function getVendor() {
  ...
  const hasAny = (...keys) => keys.some((k) => Boolean(env2[k]));
...
const noop = async function noop2() {
};
